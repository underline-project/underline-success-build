...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s underline-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  underline-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded underline transaction") + "\n" +
              "  underline-tx [options] -create [commands]   " + _("Create hex-encoded underline transaction") + "\n" +
              "\n";
