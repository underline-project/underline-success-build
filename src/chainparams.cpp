...
public:
    CMainParams() {
         ...
         */
        pchMessageStart[0] = 0x55; //HX "U" http://www.asciitable.com/
        pchMessageStart[1] = 0x43; //HX "C" http://www.asciitable.com/
        pchMessageStart[2] = 0x4f; //HX "O" http://www.asciitable.com/
        pchMessageStart[3] = 0x49; //HX "I" http://www.asciitable.com/
        nDefaultPort = 9333;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,68); //Decimal version 'U"
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,5);
        base58Prefixes[SCRIPT_ADDRESS2] = std::vector<unsigned char>(1,50);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,68);
        base58Prefixes[EXT_PUBLIC_KEY] = {0x75, 0x88, 0xB2, 0x1E}; //HX "u" http://www.asciitable.com/
        base58Prefixes[EXT_SECRET_KEY] = {0x75, 0x88, 0xAD, 0xE4}; //HX "u" http://www.asciitable.com/
