...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1521707118, 1266550, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x8a6f8d770df4ac207c10cf723a3c8f3a503bd67f5285ab24679202294a06504d"));
        assert(genesis.hashMerkleRoot == uint256S("0x4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        // vSeeds.emplace_back("seed-a.underline.loshan.co.uk", true);
        // vSeeds.emplace_back("dnsseed.thrasher.io", true);
        // vSeeds.emplace_back("dnsseed.underlinetools.com", true);
        // vSeeds.emplace_back("dnsseed.underlinepool.org", true);
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x55, 0x88, 0xB2, 0x1E};
        base58Prefixes[EXT_SECRET_KEY] = {0x55, 0x88, 0xAD, 0xE4};
        ...
        checkpointData = (CCheckpointData) {
            {
              {     0, uint256S("0x8a6f8d770df4ac207c10cf723a3c8f3a503bd67f5285ab24679202294a06504d")},
/*
...
*/
        ...
        chainTxData = ChainTxData{
            ...
            1521707118, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 1 * 12 * 60 * 60; // 1/2 days (12 hours)
        consensus.nPowTargetSpacing = 1 * 60; // one minutes
        ...
        vSeeds.emplace_back("testnet-seed.underlinetools.com", true);
        vSeeds.emplace_back("seed-b.underline.loshan.co.uk", true);
