...
const char * const BITCOIN_CONF_FILENAME = "underline.conf";
const char * const BITCOIN_PID_FILENAME = "underline.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Underline";
#else
    // Unix
