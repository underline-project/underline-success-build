...
const char* BIP71_MIMETYPE_PAYMENT = "application/underline-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/underline-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/underline-paymentrequest";
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start underline: click-to-pay handler"));
        }
        else {
    ...
    if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        else // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Underline address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
