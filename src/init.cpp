...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/underline-project/underline>";
    const std::string URL_WEBSITE = "<https://underline.org>";
